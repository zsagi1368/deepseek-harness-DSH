...
export declare function GoalBar({ goal, onEdit, onPause, onResume, onClear, t }: GoalBarProps & PropsLocale<'goal'>): any;
...
export declare function GoalDock({ useProjection, onEdit, onPause, onResume, onClear, t }: GoalDockProps): any;
