 ...
 */
export declare function TriggerContent({ wide, t }: TriggerContentProps): any;
/**
 * Render the panel title text.
 * @param props - composed slot props.
 * @returns the title text node.
 */
export declare function HeaderContent({ t }: HeaderContentProps): any;
 ...
 */
export declare function CloseLabel({ t }: CloseLabelProps): any;
