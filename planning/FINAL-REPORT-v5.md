...
本研究针对 dsh v0.1.0-rc.7 进行了系统性缺陷识别和修复，共发现 **12 个核心问题**，已完成 **Phase 1 全部 10 项关键修复**。
...
### Fix 10: Budget Limit Checkpoint (DSH-006-补) ✅

**预算检查**:
```typescript
// packages/core/agent-loop/src/agent.ts
if (stats.inputTokens + projectedTokens > budgetLimit) {
...
| Hook 权限检查 | -1% |
| 加密/解密 | +5ms (可选) |
| Duplicate route 检测 | -0.1% |
| Budget checkpoint | <1ms |
